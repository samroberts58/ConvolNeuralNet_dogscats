...
import time
############################################Pre Processing Data##############################################################
my_root = '/home/ubuntu/final_project/FinalProject'
os.chdir(my_root)
...
solver = caffe.SGDSolver('alexnet_solver_oxford.prototxt')
...
plt.savefig('feature_map2.png', format='png')
...
#plt.grid(True)
plt.savefig('feature_map3.png', format='png')
#----------------------------------------------------------------------------------------------
...
plt.savefig('conv1All.png', format='png')
...
# plt.savefig('conv2All.png', format='png')
#----------------------------------------------------------------------------------------------
...
#plt.show()
#plt.savefig('conv1.png', format='png')
#----------------------------------------------------------------------------------------------
