# %%%%%%%%%%%%% DATS 6203 Machine Learning 2: Final Project # %%%%%%%%%%%%%
# %%%%%%%%%%%%% Authors  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Leslie Juengst ----->Email: ljuengst25@gwu.edu
# Samantha Roberts ------>Email: samroberts@gwu.edu
# %%%%%%%%%%%%% Due Date:
# April 29th, 2019
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# %%%%%%%%%%%%% Caffe  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
import time
############################################Pre Processing Data##############################################################
#my_root = '/home/ubuntu/FinalProject/'
#os.chdir(my_root)
#----------------------------Becareful about the Directories------------------------------------
#----------If you change Directory Change the Directories in a Shell Files too------------------

#os.system("sh get_oxford.sh")
#os.system("sh create_oxford.sh")
#######################################Train the Network with the Solver######################################################

#caffe.set_device(0)
caffe.set_mode_gpu()

#solver = caffe.get_solver('lenet_solver_oxford.prototxt')
# Use SGDSolver, namely stochastic gradient descent algorithm
solver = caffe.SGDSolver('lenet_solver_oxford_var1.prototxt')
...
#solver.net.backward()
#solver.step(1)
#solver = caffe.SGDSolver('solver_oxford.prototxt')
...
test_total_time = test_end-train_start

print('Training Time (seconds): ' + str(train_total_time))
print('Testing Time (seconds): ' + str(test_total_time))